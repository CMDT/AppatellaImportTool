...
-- Description lists items from the session_to_message_mapping table for a particular course
select  distinct t4.*
...
inner join session_to_message_mapping t4 on (t3.session = t4.session);